    ...
    public class AuthController : ControllerBase
    {
        ...
        public IActionResult Register(UserRegister register)
        {
            try
            {
                ...
                var user = new User { Email = register.Email, Fullname = register.Fullname, Password = hashed };
                _context.Users.Add(user);
                _context.SaveChanges();
                return Ok(new UserDTO { Email = user.Email, Fullname = user.Fullname, Token = GenJWT(user) });
