...
{
    options.AddPolicy("SuperAdmin", policy =>policy.RequireClaim(ClaimTypes.Email, "demo01@gmail.com"));
    options.AddPolicy("ValidYearOld", policy => policy.AddRequirements(new T2204M_API.Requirements.YearOldRequirement(
...
builder.Services.AddSingleton<IAuthorizationHandler, T2204M_API.Henders.ValidYearOldHandler>();
